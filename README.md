...
> 本模板基于 [XayahSuSuSuSu/Latex-HNUThesisTemplate](https://github.com/XayahSuSuSuSu/Latex-HNUThesisTemplate) 修改，遵循 Apache-2.0 协议。
...
## 使用
### Overleaf（推荐）
1. 下载[Releases]()中的`Source code(zip)`
